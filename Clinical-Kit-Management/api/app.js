...
var logger = log4js.getLogger('KitManagementAPI');
...
// POST KitManufacturer
app.post('/manufacturer', awaitHandler(async (req, res) => {
	logger.info('================ POST on KitManufacturer');
	var args = req.body;
	var fcn = "createKitManufacturer";
...
// POST CRO
app.post('/CRO', awaitHandler(async (req, res) => {
